...
const Volunteerdetails = React.lazy(() =>
  import('./components/pages/Volunteerdetails')
);
// FAQ's
...
const Ministrydetails = React.lazy(() =>
  import('./components/pages/Ministrydetails')
);
// Services
...
const Donationgrid = React.lazy(() =>
  import('./components/pages/Donationgrid')
);
// Shop
        ...
        <ScrollToTop>
          ...
          <Switch>
            ...
            <Route
              ...
              component={(props) => (
                <Volunteerdetails {...props} key={window.location.pathname} />
              )}
            />
            {/* FAQ's */}
            ...
            <Route
              ...
              component={(props) => (
                <Events {...props} key={window.location.pathname} />
              )}
            />
            <Route
              exact
            ...
            <Route
              ...
              component={(props) => (
                <Sermons {...props} key={window.location.pathname} />
              )}
            />
            ...
            <Route
              ...
              component={(props) => (
                <Ministries {...props} key={window.location.pathname} />
              )}
            />
            <Route
              exact
            ...
            <Route
              ...
              component={(props) => (
                <Ministrydetails {...props} key={window.location.pathname} />
              )}
            />
            {/* Services */}
